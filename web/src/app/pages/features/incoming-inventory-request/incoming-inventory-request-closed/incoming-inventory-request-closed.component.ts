...
@Component({
  selector: 'app-incoming-inventory-request-closed',
  templateUrl: './incoming-inventory-request-closed.component.html',
  styleUrls: ['./incoming-inventory-request-closed.component.scss']
})
export class IncomingInventoryRequestClosedComponent {
  tabIndex = 0;
  error:string;
  dataSource = {
        ...
        if(res.success){
          let data = res.data.results.map((d)=>{
            return {
              ...
              url: `/incoming-inventory-request/closed-request/${d.inventoryRequestCode}/details`,
